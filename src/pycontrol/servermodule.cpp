...
static PyMethodDef ModuleMethods[] = {
	def("reload", "Stop and restart the python interpreter then reload all python systems."),
	...
	{"serverClients", 			serverClients, 				METH_VARARGS, "Tuple of client numbers."},
	{"serverClientStates", 		serverClientStates, 		METH_VARARGS, "Dictionary of client states indexed by cn."},

	{"clientName", 				clientName, 				METH_VARARGS, "Get name of client from cn."},
	{"clientConnectPwd", 		clientConnectPwd, 			METH_VARARGS, "Get the connectpwd of client by cn."},
	{"clientSessionId", 		clientSessionId, 			METH_VARARGS, "Session ID of client."},
	{"clientIpLong", 			clientIpLong, 				METH_VARARGS, "Get IP of client from cn."},
	{"clientPrivilege", 		clientPrivilege, 			METH_VARARGS, "Integer representing client privilege"},
	{"clientFrags", 			clientFrags, 				METH_VARARGS, "Number of frags by client in current match."},
	{"clientTeamkills", 		clientTeamkills, 			METH_VARARGS, "Number of teamkills by client in current match."},
	{"clientDeaths", 			clientDeaths, 				METH_VARARGS, "Number of deaths by client in current match."},
	{"clientShots", 			clientShots, 				METH_VARARGS, "Shots by client in current match."},
	{"clientHits", 				clientHits, 				METH_VARARGS, "Hits by client in current match."},
	{"clientPing", 				clientPing, 				METH_VARARGS, "Current ping of client."},
	{"clientScore", 			clientScore, 				METH_VARARGS, "Flags client has scored."},
	{"clientDamageDealt", 		clientDamageDealt, 			METH_VARARGS, "Damage dealt by client in current game."},
	{"clientDamageRecieved", 	clientDamageRecieved, 		METH_VARARGS, "Damage received by client in current game."},
	{"clientTeam", 				clientTeam, 				METH_VARARGS, "Team client is member of."},
	{"clientIsSpectator", 		clientIsSpectator, 			METH_VARARGS, "client is a spectator"},
	{"clientIsInvisible", 		clientIsInvisible, 			METH_VARARGS, "client is invisible."},
	{"clientMapCrc", 			clientMapCrc, 				METH_VARARGS, "Map CRC of client."},
	{"clientMapName", 			clientMapName, 				METH_VARARGS, "Map name of client."},

	{"clientInitialize", 		clientInitialize, 			METH_VARARGS, "Send the initial map change and items list to the client after they have connected."},
	{"clientMessage", 			clientMessage, 				METH_VARARGS, "Send a message to player."},
	{"clientMessageAll", 		clientMessageAll, 			METH_VARARGS, "Send a message as a player(from, to, text)."},
	{"clientMessageTeam", 		clinetMessageTeam, 			METH_VARARGS, "Send a team message as a player(from, to, text)."},
	{"clientSetVariable", 		clientSetVariable, 			METH_VARARGS, "Set a clients variables."},
	{"clientSetPrivilege", 		clientSetPrivilege, 		METH_VARARGS, "Set client privilege."},
	{"clientSetTeam", 			clientSetTeam, 				METH_VARARGS, "Set team of client."},
	{"clientPregameSetTeam", 	pregameSetTeam, 			METH_VARARGS, "Set team of player as a result of autoteam event."},
	{"clientSetState", 			clientSetState, 			METH_VARARGS, "Set the client state."},
	{"clientDisconnect", 		clientDisconnect, 			METH_VARARGS, "Disconnect client from server for a specified reason."},
	{"clientSetVisible", 		clientSetVisible, 			METH_VARARGS, "Set whether or not this client is visible."},
	{"clientRequestAuth", 		clientRequestAuth, 			METH_VARARGS, "Request that a clients client autoauth."},
	{"clientSendChallengeAuth", clientSendChallengeAuth, 	METH_VARARGS, "Send auth challenge to client."},
	{"clientChallengeAuth", 	clientChallengeAuth, 		METH_VARARGS, "given (cn, serverDesc, id, pubkey) sends challenge to client and returns correct answer."},
	{"clientSendDemo", 			clientSendDemo, 			METH_VARARGS, "Send demo to client."},

	{"serverUptime", 			serverUptime, 				METH_VARARGS, "Number of milliseconds server has been running."},
	{"serverSecondsRemaining", 	serverSecondsRemaining, 	METH_VARARGS, "seconds remaining in current match."},
	{"serverPaused", 			serverPaused, 				METH_VARARGS, "Is the game currently paused."},
	{"serverMasterMode", 		serverMasterMode, 			METH_VARARGS, "Server master mode."},
	{"serverGameMode", 			serverGameMode, 			METH_VARARGS, "Current game mode."},
	{"serverMapName", 			serverMapName, 				METH_VARARGS, "Current map name."},
	{"serverModeName", 			serverModeName, 			METH_VARARGS, "Name of game mode."},
	{"serverMaxClients", 		serverMaxClients, 			METH_VARARGS, "Get current maximum number of allowed clients."},
	{"serverTeamScore", 		serverTeamScore, 			METH_VARARGS, "Score of team."},
	{"serverMatchRecording", 	serverMatchRecording, 		METH_VARARGS, "Is this match being recorded."},

	{"serverMessage", 			message, METH_VARARGS, "Send a server message."},
	{"serverSetBotLimit", 		setBotLimit, METH_VARARGS, "Set server bot limit."},
	{"serverSetPaused", 		setPaused, METH_VARARGS, "Set game to be paused."},
	{"serverSendMapReload", 	sendMapReload, METH_VARARGS, "Causes all users to send vote on next map."},
	{"serverSetMap", 			setMap, METH_VARARGS, "Set to map and mode."},
	{"serverSetMapItems", 		setMapItems, METH_VARARGS, "Populate the servers entity spawn tracking data."},
	{"serverSetMapFlags", 		setMapFlags, METH_VARARGS, "Populate the servers flag spawn tracking data for flag modes."},
	{"serverSetMapBases", 		setMapBases, METH_VARARGS, "Populate the servers base spawn tracking data for capture modes."},
	{"serverSetMaxClients", 	setMaxClients, METH_VARARGS, "Set maximum number of allowed clients."},
	{"serverSetMasterMode", 	setMasterMode, METH_VARARGS, "Set server master mode."},
	{"serverSetMasterMask", 	setMasterMask, METH_VARARGS, "Set maximum master mode a master can set."},
	{"serverSetSecondsRemaining", setSecondsLeft, METH_VARARGS, "Set the number of seconds remaining in current game."},
	{"serverSetIntermission", serverSetIntermission, METH_VARARGS, "Set whether or not persistent intermission is enabled."},
